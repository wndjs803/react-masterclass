...
const svg = {
  start: { pathLength: 0, fill: "rgba(255, 2555, 255, 0" },
  end: {
    pathLength: 1,
    fill: "rgba(255, 2555, 255, 1",
  },
};
    ...
    <Wrapper>
      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <motion.path
          ...
          animate="end"
          transition={{
            default: { duration: 5 }, // 모든 property에 적용됨
            fill: { duration: 2, delay: 3 }, // 이런식으로 지정하면 default보다 우선 적용
          }}
